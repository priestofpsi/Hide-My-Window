...
namespace theDiary.Tools.HideMyWindow
{
    ...
    {
        /// <summary>
        /// The event that is raised when a Window associated to a <c>Pinned</c> <see cref="WindowInfo"/> instance has been minimized.
        /// </summary>
        public event WindowEventHandler Minimized;

        /// <summary>
        /// The event that is raised when a Window associated to a <c>Pinned</c> <see cref="WindowInfo"/> instance has been restored from a minimized hidden state.
        /// </summary>
