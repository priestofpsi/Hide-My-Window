...
{
    /// <summary>
    /// Indicates the show command that can be used on a Window.
    /// </summary>
    public enum WindowShowCommand
    {
        ...
        ///     window is not activated.
        /// </summary>
        MinimizeAndShowWithNoActivation = 7,
