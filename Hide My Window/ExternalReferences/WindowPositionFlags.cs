...
{
    /// <summary>
    /// Defines the set of flags used for positioning and sizing of a Window.
    /// </summary>
    [Flags]
    internal enum WindowPositionFlags
    {
        ...
        /// </summary>
        BlockWindowSyncPaintMessages = 0x2000,
        ...
        /// <summary>
        /// Discards the entire contents of the client area. If this flag is not specified, the valid contents of the client area are saved and copied back into the client area after
        ...
        /// and any part of the parent window uncovered as a result of the window being moved. When this flag is set, the application must explicitly invalidate or redraw any parts of 
        ...
        /// </summary>
        BlockWindowPositionChangeMessages = 0x0400,

        /// <summary>
        /// Retains the current size (ignores the width and hight parameters).
        /// </summary>
        IgnoreResizing = 0x0001,
